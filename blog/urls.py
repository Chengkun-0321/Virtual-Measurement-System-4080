...
urlpatterns = [
    ...
    path('download-sample/', views.download_random_100, name='download_sample'),
    path("api/upload_npy/", views.upload_npy, name="upload_npy"),
    path("api/predict/", views.predict_from_selected_rows, name="predict_model"),
    path('analysis/', views.data_analysis, name='data'),                  # 資料分析頁面
    path('analysis/file/<str:file_type>/<str:model_name>/', views.download_file, name='download_file'),
